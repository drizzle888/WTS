...
public class SubjectVersionController extends WebUtils{
  ...
  @RequestMapping("/edit")
  @ResponseBody
  public Map<String, Object> editSubmit(SubjectVersion entity, HttpSession session) {
        // TODO 自动生成代码,修改后请去除本注释
    try {
      entity = subjectVersionServiceImpl.editSubjectversionEntity(entity,
  ...
  public Map<String, Object> addSubmit(SubjectVersion entity, HttpSession session) {
        // TODO 自动生成代码,修改后请去除本注释
    try {
      entity = subjectVersionServiceImpl.insertSubjectversionEntity(entity,
          getCurrentUser(session));
  ...
  public ModelAndView index(HttpSession session) {
    return ViewMode.getInstance()
        .returnModelAndView("exam/SubjectversionResult");
  }
        /**
   * 显示详细信息（修改或浏览时）
   *
